...
description: "Initial biopsy results are complicated creating a catch-22 for treatment."
author: Colin C.
date: 2024-04-16
# date-modified: 2024-04-11
categories: [regular, new-sites, results]
draft: false
editor: 
  markdown: 
    wrap: 72
...
-   This new spot does need to be treated.
-   The main method of treatment for this new growth is in conflict with
...
dangerous agitation of Sam's liver, and that it needs to be treated.
...
We are in 'catch-22' situation. The new site in Sam's liver needs to be
treated as it is likely the major source of ongoing agitation to Sam's
...
steroids (i.e. Prednisone) -- Sam is currently on these.
...
The imaging from this morning's ultrasound should provide the medical
...
:   In waiting for the liver issue to be resolved we are delaying immune
